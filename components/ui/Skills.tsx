        ...
        <div className="flex flex-col justify-center items-center ">
            ...
            <section className="mt-20 flex w-full justify-center items-center gap-20 ">
                ...
                {skills.map((work,index) => (
                    <div className="flex flex-col gap-4 justify-center items-center bg-gradient-to-br from-cyan-400 to-emerald-400 hover:to-cyan-400 duration-500 select-none text-black font-bold p-10 rounded-4xl" key={index}>
